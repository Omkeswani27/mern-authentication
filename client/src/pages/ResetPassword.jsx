...
{!isOtpSubmited && isEmailSent && 
      <form  onSubmit={onSubmitOTP} className='p-8 text-sm rounded-lg shadow-lg bg-slate-900 w-96'>
        ...
        <p className='mb-6 text-center text-indigo-300'>Enter the 6-digit code sent to email id.</p>
...
{isOtpSubmited && isEmailSent && 
      <form onSubmit={onSubmitNewPassword} className='p-8 text-sm rounded-lg shadow-lg bg-slate-900 w-96'>
