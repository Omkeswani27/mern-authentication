...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center px-4 mt-20 text-center text-gray-800'>
      ...
      <h1 className='flex items-center gap-2 mb-2 text-xl font-medium sm:text-3xl'>Hey {userData ? userData.name : 'Developer'}! <img src={assets.hand_wave} alt="" className='w-8 aspect-square'/></h1>
